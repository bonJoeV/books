...
# Config
TARGET_DIR = "."  # or "visuals" if you're storing PMG in a subfolder
...
png_files = [
    ...
    if f.endswith(".png") and f not in EXCLUDE_FILES
]
...
<head>
  <meta charset="UTF-8">
  <title>Image Visual Gallery</title>
  <style>
...
print(f"✅ index.html generated with {len(png_files)} HTML files.")
